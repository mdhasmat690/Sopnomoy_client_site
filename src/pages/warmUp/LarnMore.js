      ...
      <div>
        <div className="grid md:grid-cols-2   md:bg-[#fdf6f9] pb-10 sm:bg-white">
          <div className="bg-white">
            <img
              src="https://i.ibb.co/mN2vvn3/playoff.png"
          ...
          <div className="flex items-center justify-center md:mb-0 sm:mb-14 p-4">
            <div className=" ">
              ...
              <div className="md:grid md:grid-cols-4 gap-3 mt-5 md:ml-[155px] flex flex-wrap sm:ml-none">
                <div>
                  {" "}
        ...
        <div className="md:w-[53%] w-[80%] md:p-none sm:p-2 mx-auto text-justify">
          <div className="flex items-center">
            <span className="mr-3 text-[#ea4c89] text-[40px] font-[700]">
              A
            </span>
          ...
          <h1 className="text-[#6e6d7a] mt-4">
            ...
            design—design work for the explicit sake of pushing the limits of
            your visual wheelhouse, while also encouraging you to flex your
            creative muscles.
          </h1>
        </div>
        <div className="w-[70%] mx-auto mt-10 grid md:grid-cols-3 gap-6">
          <img
            src="https://i.ibb.co/ym93WV6/playoff1.png"
            className="w-full"
            alt=""
          />
          <img
            src="https://i.ibb.co/F6VPYDX/playoff2.png"
            className="w-full"
            alt=""
          />
          <img
            src="https://i.ibb.co/3CThyCw/playoff3.png"
            className="w-full"
            alt=""
          />
          <img
            src="https://i.ibb.co/gVJysSJ/p1.png"
            className="w-full"
            alt=""
          />
          <img
            src="https://i.ibb.co/m0V12Gw/p2.png"
            className="w-full"
            alt=""
          />
          <img
            src="https://i.ibb.co/TPpJsrh/p3.png"
            className="w-full"
            alt=""
          />
        </div>
